...
def run_train():
    ...
    fold = 2
    out_dir = \
        '/home/glennsu/Kaggle Competition Dataset/HuBMAP - Hacking the Kidney/result/en-resnet34-256-aug/fold%d'%fold
    initial_checkpoint = \
        data_dir+'/Code/checkpoint/00010000_model.pth'
#        data_dir+'/Code/checkpoint/00009500_model.pth' #None #'/root/share1/kaggle/2020/hubmap/result/en-resnet34-256-2-aug3/fold2/checkpoint/00006500_model.pth'
        #
